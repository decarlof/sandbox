...
def main(args):
    ...
    if len(sys.argv) == 1:
        ...
        print ('Example:')
        print ('        python nikon.py /Users/decarlo/conda/nocturn/data/FEG230530_413/')
        sys.exit(1)
    else:
        ...
        if p.is_dir():
            ...
            file_name_ctinfo_dtxml = p.with_suffix('.ctinfo.xml')
            print(file_name_ctinfo_dtxml)
            exit()
